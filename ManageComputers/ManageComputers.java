...
public class ManageComputers {
    // ===== Whitelist constants (Secure Coding – Input Validation) =====
private static final String[] VALID_CPUS    = {"Intel i5","Intel i7","Intel i9","Ryzen 5","Ryzen 7"};
private static final String[] VALID_RAM     = {"8GB","16GB","32GB"};
private static final String[] VALID_DISKS   = {"256GB SSD","512GB SSD","1TB HDD"};
private static final String[] VALID_GPUS    = {"Integrated","NVIDIA GTX 1650","NVIDIA RTX 3060"};
private static final String[] VALID_SCREENS = {"13\"","14\"","15.6\""};

// Prompts until the user enters a whitelisted value
private static String promptValidated(Scanner s, String prompt, String[] valid) {
    while (true) {
        ...
        System.out.println("Invalid input. Valid options are: " + java.util.Arrays.toString(valid));
    }
}
    ...
    private static void addComputer(ArrayList<Computer> computers, Scanner s) {
        ...
        switch(computerType) {
            ...
            //Get CPU, RAM and Disk info
                ...
                String GPUType = promptValidated(s, "Enter GPU:", VALID_GPUS);
        ...
        if (computerListNumberToEdit>=1 && computerListNumberToEdit<=computers.size()) {
            ...
            switch(computerType) {
                ...
                case "laptop": 
                   ...
                   String screenSize = promptValidated(s, "Enter screen size:", VALID_SCREENS);
    ...
    private static Computer getComputerData(Scanner s) {
       ...
       CPU  = promptValidated(s, "Enter CPU:",  VALID_CPUS);
RAM  = promptValidated(s, "Enter RAM:",  VALID_RAM);
disk = promptValidated(s, "Enter Disk:", VALID_DISKS);
